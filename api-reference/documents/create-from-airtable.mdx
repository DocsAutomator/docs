...
When your automation's data source is set to **Airtable**, you only need to pass the Airtable record ID. All field mapping, line items, and output settings are configured in the DocsAutomator app.
