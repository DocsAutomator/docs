...
When your automation's data source is set to **API**, you pass all field data directly in the request body. This is the most flexible option — you control exactly what data goes into the document.
...
<ParamField body="existingPdfs" type="array">
