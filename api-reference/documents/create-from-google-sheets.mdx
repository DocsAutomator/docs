...
When your automation's data source is set to **Google Sheets**, you only need to pass the row number. All field mapping, line items, and output settings are configured in the DocsAutomator app.
