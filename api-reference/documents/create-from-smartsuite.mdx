...
When your automation's data source is set to **SmartSuite**, you only need to pass the record ID. All field mapping, line items, and output settings are configured in the DocsAutomator app.
