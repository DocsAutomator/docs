...
<Frame caption="Choose how to start your template">
  <img src="/images/quickstart/template-type-selection.png" alt="Template type selection showing Google Docs, Microsoft Word, and Upload an existing PDF options" />
</Frame>
