...
<Tabs>
  <Tab title="Google Doc Template">
    ...
    <AccordionGroup>
      ...
      <Accordion title="Convert a Word Template" icon="file-word">
        Have an existing `.docx` template? Upload it and DocsAutomator will automatically convert it to a Google Doc. See the [Google Doc Template Guide](/docsautomator-basics/google-doc-template-guide#converting-word-templates) for details.
      </Accordion>
