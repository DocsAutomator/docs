...
<Tip>
The fastest way to your first automation is the [DocsAutomator AI Agent](/features/docsautomator-ai-agent): describe the document you need in the chat on the left side of the app and it builds the automation for you, template included. The steps below walk through the manual setup.
</Tip>

## 1. Create New Automation

After logging in, you'll see the initial dashboard. Click the green **New** button and choose **New automation** to begin setting up document generation.

<Frame caption="Click New, then New automation to get started">
  <img src="/images/quickstart/dashboard.png" alt="DocsAutomator dashboard with the New button" />
</Frame>

<Note>
An automation combines your data source (Airtable, Google Sheets, etc.) with a template: a Google Doc, a Word (.docx) file, or a PDF.
</Note>
...
<Frame caption="Choose how to start your template">
  <img src="/images/quickstart/template-type-selection.png" alt="Template area offering Create template with AI, Browse templates and Start from scratch, above a drag and drop area for PDF, Word and Google Docs files" />
</Frame>
...
<Tabs>
  <Tab title="Google Doc Template">
    ...
    <Frame caption="Browse the template library and apply a ready-made design">
      <img src="/images/quickstart/choose-template.png" alt="Template library showing featured designs by category, with format toggles for Word and Google Docs" />
    </Frame>
    ...
    <AccordionGroup>
      ...
      <Accordion title="Use a Word (.docx) Template" icon="file-word">
        Prefer Microsoft Word? Choose **Start from scratch** and then **Microsoft Word**, or upload your own `.docx` directly. See the [Word Template Guide](/docsautomator-basics/word-template-guide) for details.
      </Accordion>
...
<Frame caption="Pick the app that holds your data">
  <img src="/images/quickstart/choose-data-source.png" alt="Data Source picker showing Airtable, Google Sheets, Google Forms, Notion, SmartSuite and ClickUp, plus Zapier, Make, n8n, Softr, Glide, Noloco and the DocsAutomator API and MCP server" />
</Frame>
...
<Frame caption="Generate a preview to verify your document looks correct">
  <img src="/images/quickstart/preview.png" alt="Preview dialog showing a generated invoice PDF for the selected record" />
</Frame>
...
<Frame caption="Configure what happens after each document is generated">
  <img src="/images/quickstart/output-settings.png" alt="Add action dialog offering Save PDF URL to Airtable field, Save Word document, Save PDF in Google Drive, Save in Documents folder, Save PDF in OneDrive, Send Email, Merge Existing PDFs and Notify Webhook" />
</Frame>

<Info>
Want to collect signatures? Enable e-signatures in the **E-Signing** card of your automation. See the [eSign guide](/features/docsautomator-esign) for setup instructions.
</Info>

<Frame caption="E-signature settings: add signers and take their email from your data or a fixed address">
  <img src="/images/quickstart/esign-settings.png" alt="E-Signing panel with two signers: one taking the email and name from data fields, one using a fixed email address" />
</Frame>
