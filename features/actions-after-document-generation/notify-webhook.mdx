...
<Steps>
  <Step title="Open the Actions card">
    In the automation editor, open the **Actions** card in the right rail and click **Add action**
  </Step>
  <Step title="Add the webhook action">
    Pick **Notify Webhook** from the action list
  </Step>
