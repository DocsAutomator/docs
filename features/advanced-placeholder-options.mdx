...
<CardGroup cols={2}>
  ...
  <Card title="Show Unique Values Only" icon="layer-group" href="/features/advanced-placeholder-options/show-unique-values">
    Collapse repeated values read through Airtable linked records
  </Card>
...
<Info>
- Compatible across all data sources, except "Show Unique Values Only", which is for Airtable linked records
...
<Tip>
Test your advanced options in Test Mode before generating production documents.
</Tip>
