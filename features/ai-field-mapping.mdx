...
When you reach the field mapping step of automation setup, click the **1-click AI mapping** button. The system:

1. Reads all placeholder names from your template, whether it is a Google Doc, a Word file, or a PDF
...
<Steps>
  <Step title="Set Up Your Automation">
    Create an automation, add your template, then connect your data source as usual.
  </Step>
  <Step title="Open Data / Placeholders">
    Open the **Data / Placeholders** panel on the right, where the **Data Mapping** list shows every placeholder found in your template.
  </Step>
  <Step title="Click AI Field Mapping">
    Click **1-click AI mapping**. The system analyzes your placeholders and fields, then suggests the best matches.
  </Step>
...
- **Long names**: Drag the left edge of the mapping panel to make it wider. Wide enough, and each row shows the placeholder and its field side by side, with full names visible
