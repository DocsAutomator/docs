...
| Paid (all plans) | Full production access at $0.50 per closed document |

### How e-signing and acceptance are billed

- You pay **$0.50 per closed document**. A closed document is one signing request or one acceptance request.
...
- Above 1,000 closed documents in a billing month, each one costs **$0.35**. The count starts again with each billing month.
