...
- You pay **$0.50 per document, charged when the recipient first opens it; $0.35 per document above 1,000 a month**. One document is one signing request or one acceptance request.
...
- The $0.35 rate applies to every document above 1,000 in a billing month. The count starts again with each billing month.
