...
E-signing is included on all paid plans (Professional, Business, and Scale) at **$0.50 per document sent for signature**. The charge is flat per document, regardless of how many signers are on it, and applies when the document is sent out for signing. No add-on subscription is required.

| Plan | eSign Access |
|------|--------------|
| Free (test mode) | Preview/Test signing only |
| Paid (all plans) | Full production access at $0.50 per document sent for signature |
