...
<Frame caption="The How it completes choice in the Signing & Acceptance card, with Acceptance selected">
  <img src="/images/esign/acceptance-closing-choice.png" alt="The Signing & Acceptance card of an automation. Under How it completes, the three options Signature required, Acceptance, and None are shown, with Acceptance selected." />
</Frame>
...
**If the other side expects to sign, use Signing. If you only need their yes, use Acceptance.** If you are not sure whether a yes is enough for your document, read [Is acceptance legally binding?](/features/docsautomator-esign/is-acceptance-legally-binding).
