...
<Steps>
  ...
  <Step title="Choose how the request reaches the recipient">
    ...
    <Frame caption="The Acceptance setup card: link delivery, recipient order, expiration, Require Typed Name, and reminders">
      <img src="/images/esign/acceptance-setup-card.png" alt="The Acceptance setup card in the Settings tab. Send via Email is selected over Links Only. Recipient order is Parallel. Link Expiration is 30 days. Require Typed Name is on. Send Reminders is on." />
    </Frame>
  </Step>
