...
The Electronic Signatures in Global and National Commerce Act says a signature, contract or record may not be denied legal effect only because it is electronic. It applies to documents that need no special form.
