...
For consumers who take on a payment obligation by accepting, EU and UK law requires extra steps on the accept page that Acceptance does not provide yet. Use Signing or another route for those documents for now.
