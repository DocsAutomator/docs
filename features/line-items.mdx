...
<Info>
To repeat a whole **block** of content per record — headings, paragraphs, and tables, e.g. one section per room or per project — add a closing tag and see [Repeating Sections](/features/line-items/repeating-sections).
</Info>
...
| ClickUp | Subtasks, or a Relationship field → items list |
