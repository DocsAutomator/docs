...
| Transparent Background | Remove the fill from the header row. The row keeps the table's own look |
...
| Transparent Background | Remove the fill from the calculation row |
