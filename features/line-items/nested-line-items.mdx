...
<Steps>
  <Step title="Configure Data Source">
    In your automation's line item settings, select the linked field for each level so DocsAutomator knows which related records to pull for the child and grandchild lists.
  </Step>
