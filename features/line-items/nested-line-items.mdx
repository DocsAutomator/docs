...
<Note>
Available for Airtable, Notion, and the [DocsAutomator API](/integrations-api/docsautomator-api). Google Doc templates only — [Word templates](/docsautomator-basics/word-template-guide) do not support nested line items yet.
