...
<Info>
**DocsAutomator offers unlimited team seats on all plans, including free test mode.**
</Info>
...
- View pending invitations as rows in the Team Members table
- Cancel an invitation with the red **Cancel** link on its row, then **Confirm**
