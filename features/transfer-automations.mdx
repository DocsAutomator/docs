...
<Steps>
  ...
  <Step title="Find the Target Workspace ID">
    1. Have the target workspace owner open the **Settings** page
    2. The Workspace ID is shown at the top of the page, as "ID: ..." in the header
...
<AccordionGroup>
  ...
  <Accordion title="Can't find workspace ID">
    - Open the Settings page in the target workspace
    - The ID is shown at the top of the page, as "ID: ..." in the header
