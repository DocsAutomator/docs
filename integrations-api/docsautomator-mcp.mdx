...
>
> "Send the quote for record rec123 to Anna Weber at anna@acme.com for acceptance."
...
- On API, MCP, Zapier, Make, n8n, Glide and Noloco automations, every signer is set to `request`.
