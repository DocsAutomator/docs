...
<Tabs>
  <Tab title="Auto-Create">
    ...
    **Automatic safety shutoff:**
    If auto-creation fails 5 times in a row (e.g., due to a disconnected Google account or a deleted sheet), it is automatically disabled and workspace owners receive an email notification. Fix the underlying issue and re-enable to resume.
