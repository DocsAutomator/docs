...
<Steps>
  ...
  <Step title="Select your database">
    ...
    <Frame>
      <img src="/images/notion/database-select.png" alt="Data / Placeholders panel showing the connected Notion database and the document name property" />
    </Frame>
  </Step>
  ...
  <Step title="Map your properties to placeholders">
    ...
    <Frame>
      <img src="/images/notion/property-mapping.png" alt="Data Mapping list pairing each template placeholder with a Notion property" />
    </Frame>
  ...
  <Step title="Map line items (optional)">
    ...
    <Frame>
      <img src="/images/notion/line-items.png" alt="Line Items section showing the relation property, sort order, grouping and the mapped level 1 properties" />
    </Frame>
  </Step>
  <Step title="Preview">
  ...
  <Step title="Configure write-back in the Actions tab">
    ...
    <Frame>
      <img src="/images/notion/output-settings.png" alt="Actions panel with a Save PDF URL to Notion action and its PDF link property" />
    </Frame>
  </Step>
...
<Frame>
  <img src="/images/notion/auto-creation.png" alt="Automatic generation dialog with the Auto creation toggle, and a note that Notion batches webhook events so generation can take one to two minutes" />
</Frame>
...
<Frame>
  <img src="/images/notion/page-body-mapping.png" alt="Property picker open, with Page body (Markdown) listed above the database properties" />
</Frame>
...
| Status | Status name | |
| Date | `21/05/2024` | Honors your automation's date format. Date ranges render as `start – end`. Times included when set in Notion, in the time zone set in Notion |
