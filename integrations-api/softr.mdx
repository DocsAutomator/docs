...
<Frame>
  <iframe
    width="100%"
    height="400"
    src="https://www.youtube.com/embed/F_PF7UsqLPU"
    title="Softr Integration Overview"
    frameBorder="0"
...
- A [DocsAutomator account](https://app.docsautomator.co) (free test mode available)
...
2. Click **New**, then **New automation** in your dashboard
3. Select **Softr** as your data source
4. Choose or create your template: a Google Doc, a Word (.docx) file, or a PDF
...
In the JSON body, map your workflow data to the placeholders in your template. Use the **@** button to insert dynamic values from your workflow.
...
To include images in your documents, use the `image_` prefix for your placeholder names in your template:
...
- **Use Descriptive Placeholder Names:** In your template, name placeholders clearly (e.g., `Project_Name` instead of `name`) to make JSON mapping easier
...
<Info>
DocsAutomator supports [e-signatures](/features/docsautomator-esign) with all data sources, including Softr. After generating a document, you can automatically route it for signing. DocsAutomator also supports [Word (.docx) templates](/docsautomator-basics/word-template-guide) and [PDF templates](/docsautomator-basics/pdf-template-guide) in addition to Google Doc templates.
</Info>
