...
<AccordionGroup>
  ...
  <Accordion title="Which plans include eSign?">
    E-signing and acceptance are included on all paid plans (Professional, Business, and Scale) at **$0.50 per document, charged when the recipient first opens it; $0.35 per document above 500 a month**. It is one charge per document, no matter how many recipients are on it. A request that nobody opens is free. No add-on subscription is required.
