...
<CardGroup cols={1}>
  <Card title="Google Forms: Common Issues" icon="file-lines" href="/integrations-api/google-forms#troubleshooting">
    Respondent email field is empty, old responses not generating documents
  </Card>
</CardGroup>
