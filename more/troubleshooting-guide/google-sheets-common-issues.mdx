...
<Tabs>
  ...
  <Tab title="Auto-creation was disabled">
    If auto-creation fails 5 times in a row, it is automatically disabled to prevent repeated errors. You will receive an email notification when this happens. Check the error message, fix the issue (e.g., reconnect your Google account), and re-enable auto-creation in your automation settings.
  </Tab>
</Tabs>
