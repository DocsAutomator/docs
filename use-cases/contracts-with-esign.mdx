...
- A DocsAutomator paid plan (e-signing is included on all plans at $0.50 per document sent for signature)
...
<Steps>
  ...
  <Step title="Create the Automation">
    1. Click **New**, then **New automation** in your DocsAutomator dashboard
    2. Name it "Client Contracts"
    3. Add your contract template
    4. Open the **Data / Placeholders** panel, click **Connect**, and pick your data source:
...
<Tabs>
  ...
  <Tab title="Link Delivery">
    ...
    DocsAutomator never emails the signers of a link-delivered request. Invitations and reminders are both suppressed, including the reminder buttons in the dashboard, so a signer only ever hears from you.

    Your own team is still notified. When every signer has finished, the completion email goes to your notification recipients with a link to the signed PDF.
  </Tab>
</Tabs>
